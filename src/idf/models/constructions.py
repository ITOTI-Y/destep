...
It cannot be referenced as a layer from the Construction object."""
    ...
    name: str = Field(...)
    thickness: float = Field(..., gt=0.0, json_schema_extra={'units': 'm'})
    gas_or_gas_mixture: WindowGasAndGasMixturesRef = Field(..., json_schema_extra={'object_list': ['WindowGasAndGasMixtures'], 'note': 'This field should reference only WindowMaterial:Gas or WindowMaterial:GasMixture objects'})
...
Transmittance/Reflectance input method."""
    ...
    infrared_transmittance_applies_to_front_and_back: float | None = Field(default=0.0, ge=0.0, le=1.0, json_schema_extra={'units': 'dimensionless', 'note': 'The long-wave hemispherical transmittance of the glazing. Assumed to be the same for both sides of the glazing.'})
